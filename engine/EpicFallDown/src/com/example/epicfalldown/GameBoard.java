 ...
 * 
 * You should subclass this for your own game. There you will (among other
 * things) implement public void onEmptyTileClicked(int x, int y); which will be
 * called when the user clicked on a tile which had no game object on it.
 * 
...
public abstract class GameBoard extends Observable {
	 ...
	 * 
	 * @param obj
	 *            The object to place on the board.
	 * @param x
	 *            The X-coordinate to place the object at.
	 * @param y
	 *            The Y-coordinate to place the object at.
	 *
	...
	/**
	 * Call this to notify the game board view that it should redraw. You should
	 * call this any time you are done changing things on the board and want to
	 ...
	 * 
	 * @param object
	 *            The object to remove from the board.
	 */
	...
	/**
	 * Called if the user clicked on a tile, and no object was present on that
	 * tile.
	 * 
	 * @param x
	 *            The x-coordinate of the clicked tile
	 * @param y
	 *            The y-coordinate of the clicked tile
	 */
	 ...
	 * @param y
	 *            The x-coordinate of the tile
	 * @return A image identifier to draw on this tile, or null to use the empty
	 *         tile.
	 */
